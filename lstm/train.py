...
from GruNumpy import GruNumpy

LEARNING_RATE = float(os.environ.get("LEARNING_RATE", "0.001"))
VOCABULARY_SIZE = int(os.environ.get("VOCABULARY_SIZE", "50"))
...
INPUT_DATA_FILE = os.environ.get("INPUT_DATA_FILE", "data/script2.txt")
...
# Build model
model = GruNumpy(VOCABULARY_SIZE, hidden_dim=HIDDEN_DIM, bptt_truncate=4, layer_num=2)
...
for epoch in range(NEPOCH):
  train_with_sgd(model, x_train, y_train, learning_rate=LEARNING_RATE, nepoch=20, decay=0.9, 
